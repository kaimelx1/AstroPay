...
class AstroPayStreamline {
	 ...
	 **************************/
	private $x_login = '58c917662d';
	private $x_trans_key = '156e137a26';
	
	private $x_login_for_webpaystatus = '4a13a6e3ab';
	private $x_trans_key_for_webpaystatus = '9c9ddf39b6';
	
	private $secret_key = '7142238ca2725cea292558a72372c8d3f';
	...
	public function newinvoice($invoice, $amount, $bank, $country, $iduser, $cpf, $name, $email, $currency='', $description='', $bdate='', $address='', $zip='', $city='', $state='', $return_url='', $confirmation_url=''){
		...
		return ['requestUrl' => $this->url['newinvoice'], 'requestData' => json_encode($params_array), 'responseData' => $response];
	}
	...
	public function get_status($invoice){
        ...
        return ['requestUrl' => $this->url['status'], 'requestData' => json_encode($params_array), 'responseData' => $response];
	}
